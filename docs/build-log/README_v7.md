...
4. **Decision history.** The prompts capture not just what was built, but what was considered. Useful when the obvious answer turns out to be wrong later.
...
| 7a  | Site Owner auth (api + web)                    | ⚪ Not started | —            | —                          |
| 7b  | Sites management (api + web)                   | ⚪ Not started | —            | —                          |
| 7c  | End User self-service (`/v1/me/*` + /me page)  | ⚪ Not started | —            | —                          |
| 7d  | CSRF protection across dashboard mutations     | ⚪ Not started | —            | —                          |
